...
def main(genomes, config):
    ...
    # start pygame and environment variables
    pygame.init()
    ...
    while True:
        ...
        if game_active:
            ...
            for player in players_list:
                ...
                if obstacles_ahead:
                    # Start categorical input features
                    isEnemy = 0
                    isCoin = 0
                    isHigh = 0
                    isLow = 0
                    ...
                    if should_jump:
                        ...
                        player.sprite.genome.fitness -= 0.02  # Punish unnecessary actions
